...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/nlintz/Documents/Olin/2014-2015/Fall/CompRobo/comprobo2014/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/nlintz/Documents/Olin/2014-2015/Fall/CompRobo/comprobo2014/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/nlintz/Documents/Olin/2014-2015/Fall/CompRobo/comprobo2014/install)
...
if(NOT "/home/nlintz/Documents/Olin/2014-2015/Fall/CompRobo/comprobo2014/devel/include" STREQUAL "")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/nlintz/Documents/Olin/2014-2015/Fall/CompRobo/comprobo2014/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Nathan Lintz <nlintz@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nlintz/Documents/Olin/2014-2015/Fall/CompRobo/comprobo2014/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Nathan Lintz <nlintz@gmail.com>' to fix it.")
    endif()
...
set(depends "message_runtime;roscpp;rospy;std_msgs;tf")
